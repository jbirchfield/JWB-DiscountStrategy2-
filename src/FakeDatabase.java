...
public class FakeDatabase {
    ...
    Product[] products = {
        new Product("A101", "Baseball Hat", 19.95, new QtyVariableRateDiscount(0.15,5)),
        new Product("B205", "Men's Dress Shirt", 35.50, new VariableRateDiscount(.10)),
        new Product("C222", "Women's Socks", 9.50, new VariableRateDiscount(.20))
    };
